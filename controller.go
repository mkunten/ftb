...
// GetNgramSearch
func GetNgramSearch(es *ES) func(c echo.Context) error {
	return func(c echo.Context) error {
...
// PostRegister
func PostRegister(es *ES) func(c echo.Context) error {
	return func(c echo.Context) error {
		// get params
...
// PostBulkRegister
func PostBulkRegister(es *ES) func(c echo.Context) error {
	return func(c echo.Context) error {
		// get params
